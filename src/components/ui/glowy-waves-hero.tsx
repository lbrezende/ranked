...
const highlightPills = [
  "Baseado em pesquisa CMU",
  "10 habilidades de IA",
  "40 exemplos reais",
] as const;

const heroStats: { label: string; value: string }[] = [
  { label: "Projetos de IA que falham", value: "85%" },
  { label: "Exemplos em 14 dominios", value: "40" },
  { label: "Etapas do problema a ideia", value: "6" },
];
...
export function GlowyWavesHero() {
  ...
  return (
    <section
      ...
      role="region"
      aria-label="Hero section com ondas animadas"
    >
      <canvas
        ref={canvasRef}
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-6xl flex-col items-center px-6 py-24 text-center md:px-8 lg:px-12">
        ...
        >
          ...
          >
            ...
            AI Design Kit — Carnegie Mellon University
          </motion.div>
          ...
          >
            O Kanban de 6 etapas baseado em pesquisa academica que guia voce
            da definicao do problema ao conceito de produto com Inteligencia Artificial.
          </motion.p>
